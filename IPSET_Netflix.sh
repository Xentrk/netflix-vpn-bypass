...
#
# Required OpenVPN Client Settings
#
...
# Define Interface/bitmask to route Netflix traffic to below
# 0x7000/0x7000- WAN
...
# to prevent ipinfo.io from being blocked by Diversion and Skynet
